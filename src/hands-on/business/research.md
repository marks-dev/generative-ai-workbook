...
このハンズオンでは、検索機能を搭載したAI（SearchGPT機能、Gemini、Perplexityなど）を使い、新しいビジネスドメインや競合製品の調査資料を短時間で作成する高度なリサーチを体験します。
...
ウェブ検索を搭載したAIを活用することで、自分で何十分もブラウジングして資料にまとめる作業がわずか数分で完了します。比較項目を明確に指示するのが成功のコツです。
次のステップでは、ビジネスパーソンに必須の「Excel作業」をAIで効率化する手法を学びましょう。
