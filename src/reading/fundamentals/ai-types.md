...
この教材では、AI（人工知能）にはどのような種類があるのかについて学びます。目的や仕組みの違いによる分類を整理しましょう。

## 学習目標

- 「特化型AI」と「汎用型AI」の違いを説明できる
- 「ルールベース」と「機械学習」の違いを説明できる
...
AIには得意分野に特化した「特化型AI」と、人間のように何でもこなす「汎用型AI」があり、現代の技術は特化型AIを中心に発展しています。また、その賢さは、人間がルールを教える「ルールベース」から、データから自律的に学ぶ「機械学習」へと進化しています。
