...
- 現在フェーズ: 教材コンテンツ拡充
- 現在ステップ: タイポグラフィ・用語集刷新完了・設計書フィードバック開始
...
- [ ] 表示品質調整結果から関連 docs/*.md へのフィードバック
- [/] 既存ページの表示品質調整（カテゴリ、サブカテゴリ、既存コンテンツ）
...
- 表示品質調整結果（タイポグラフィ、外部リンク別タブ化、用語集テーブル等）の関連 docs/*.md 設計書へのフィードバック
- 既存ページの表示品質調整（カテゴリ、サブカテゴリ、既存コンテンツ）
- 「触って学ぶ - はじめての生成AI」カテゴリの未実装ページ（メールを書いてみよう、表を作ってみよう）の作成
